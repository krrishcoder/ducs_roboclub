    ...
    <footer className="w-full py-12 px-8 bg-[#050505] border-t border-primary/5 pb-24 md:pb-12">
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 max-w-7xl mx-auto">
        ...
        <div className="flex gap-8 items-center">
          <a href="https://www.instagram.com/ducs_roboclub" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 font-label text-[8px] tracking-[0.2em] uppercase text-on-surface/30 hover:text-[#E1306C] transition-colors group">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
